...
return [
    ...
    'disks' => [
        ...
        'encrypted' => ['driver' => 'local', 'root' => storage_path('app/encrypted'), 'throw' => false],
        'backup' => ['driver' => 'local', 'root' => storage_path('app/backups'), 'throw' => false],
        'reports' => ['driver' => 'local', 'root' => storage_path('app/reports'), 'throw' => false],
    ],
